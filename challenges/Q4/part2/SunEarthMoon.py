...
x = np.array([[0.],[-80000.],[-80500.]])
y = np.array([[0.],[0.],[5000.]])
m = np.array([1000000000,100000,100])
r = np.array([32,16,16])

v = np.array([[0.,0.],[10.,4000.],[-20.,4000.]])
...
ax.set_xlabel('x')
ax.set_ylabel('y')
ax.set_title("3-body problem | Star, Planet & Moon")
ax.legend(['Star', 'Planet', 'Moon'])
